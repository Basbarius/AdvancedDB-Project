...
public class DeleteWords{
    ...
    public HashMap<String, Integer> deleteWords(String inputDoc, String outputDoc) throws Exception {
        ...
        irregularVerbs = txtToHashMap("..\\trimmingDocuments\\irregularVerbs.txt");
            ...
            try (BufferedReader br = new BufferedReader(fr)) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    for (int i = 0; i < content.length; i++) {
                        ...
                        result = content[i].replaceAll("[\\p{Punct}&&[^'-]]+", "").toLowerCase();
                    ...
                    for (String stopWord : verbs) {
                        ...
                        if (!txtSearch("..\\trimmingDocuments\\stopWords.txt", stopWord)) {
